...
export const lookmodernCollection: Category = {
  id: "look-modern",
  title: "LOOK MODERN Serisi",
  description: "Premium catalog items extracted automatically.",
  brand: 'karmen',
  coverImage: "",
  products: [
  {
    "id": "look-modern-lm001g",
    "name": "LOOK MODERN LM001G",
    "description": "LOOK MODERN LM001G premium carpet model.",
    "tags": [
      "%100 Akrilik",
      "Kolay Temizlenir"
    ],
  ...
  {
    "id": "look-modern-lm002b",
    "name": "LOOK MODERN LM002B",
    "description": "Look Modern LM002B, modern tarzı konforla birleştiren özel tasarımıyla evinize sıcaklık katar. Akrilik ipliği ile üretilmiş yüzeyi yumuşak dokulu, pamuk tabanı ise sağlam ve kaymaz yapıdadır. Tozu az yapısıyla hijyenik bir ortam sunarken, krem rengiyle bulunduğu alanı ferahlatır.",
    "tags": [
      "%100 Akrilik",
      "Kolay Temizlenir"
    ],
  ...
  {
    "id": "look-modern-lm003g",
    "name": "LOOK MODERN LM003G",
    "description": "Look Modern LM003G, modern tasarım anlayışını yumuşak dokulu yüzeyiyle birleştiren fonksiyonel bir halıdır. Krem ve gri tonları ile sade ve çağdaş dekorasyonlara mükemmel uyum sağlar. Akrilik yapısı sayesinde hem dayanıklı hem de konforludur. Tozu az yapısıyla hijyenik bir ortam sunar.",
    "tags": [
      "%100 Akrilik",
      "Kolay Temizlenir"
    ],
  ...
  {
    "id": "look-modern-lm004b",
    "name": "LOOK MODERN LM004B",
    "description": "Look Modern LM004B, sade ama etkileyici görünümüyle modern yaşam alanlarınıza zarafet katar. Krem ve bej tonları ile sıcak ve huzurlu bir atmosfer oluştururken, yumuşak akrilik yapısı üst düzey konfor sunar. Toz tutmayan yapısıyla hijyenik bir tercih olan bu halı, evinizin her köşesinde güvenle kullanılabilir.",
    "tags": [
      "%100 Akrilik",
      "Kolay Temizlenir"
    ],
  ...
  {
    "id": "look-modern-lm005g",
    "name": "LOOK MODERN LM005G",
    "description": "Look Modern LM005G, sade ve modern çizgileriyle ev dekorasyonunuzda minimal şıklığı yakalamanıza yardımcı olur. Akrilik dokusu sayesinde yumuşaklık ve konfor sunarken, tozu az özelliği ile hijyenik bir kullanım sağlar. Gri rengi ile özellikle modern ve İskandinav tarzı alanlara uyum sağlar.",
    "tags": [
      "%100 Akrilik",
      "Kolay Temizlenir"
    ],
  ...
  {
    "id": "look-modern-lm005w",
    "name": "LOOK MODERN LM005W",
    "description": "Look Modern LM005W krem tonları ve modern tasarımıyla iç mekanlarınıza ferahlık ve estetik kazandırır. Yumuşak akrilik yapısı konfor sağlarken, pamuk tabanı sayesinde zeminle mükemmel uyum gösterir. Tozu az yapısıyla alerjik hassasiyeti olanlar için ideal bir tercihtir. Mutfak, koridor ve salon gibi yoğun kullanım alanlarında şıklıkla kullanılır.",
    "tags": [
      "%100 Akrilik",
      "Kolay Temizlenir"
    ],
