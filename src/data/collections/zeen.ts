...
export const zeenCollection: Category = {
  id: "zeen",
  title: "ZEEN Serisi",
  ...
  products: [
  {
    "id": "zeen-ze001b-sisal-bej-beyaz-kolay-temizlenebilir-makinede-yikanabilir-mutfak-halisi",
    "name": "ZEEN ZE001B SISAL BEJ BEYAZ KOLAY TEMIZLENEBILIR MAKINEDE YIKANABILIR MUTFAK HALISI",
    "description": "ZEEN ZE001B SISAL BEJ BEYAZ KOLAY TEMIZLENEBILIR MAKINEDE YIKANABILIR MUTFAK HALISI premium carpet model.",
    "tags": [
      "%100 Akrilik",
      "Kolay Temizlenir"
    ],
  ...
  {
    "id": "zeen-ze001g-sisal-gri-siyah-kolay-temizlenebilir-makinede-yikanabilir-mutfak-halisi",
    "name": "ZEEN ZE001G SISAL GRI SIYAH KOLAY TEMIZLENEBILIR MAKINEDE YIKANABILIR MUTFAK HALISI",
    "description": "Modern ve endüstriyel dekorasyon tarzını sevenler için tasarlanan Zeen Koleksiyonu, gri ve siyahın asaletini zeminlerinize taşıyor. Balıksırtı deseninin modern yorumuyla dokunan ZE001G Sisal Halı, siyah çerçeve detayıyla mekanlarınıza net ve şık bir karakter kazandırır. Özellikle mutfak ve antre gibi yoğun kullanılan alanlarda kiri belli etmeyen yapısı ve doğal sisal jüt halı estetiği ile vazgeçilmeziniz olacak.",
    "tags": [
      "%100 Akrilik",
      "Kolay Temizlenir"
    ],
  ...
  {
    "id": "zeen-ze001w-sisal-gri-beyaz-kolay-temizlenebilir-makinede-yikanabilir-mutfak-halisi",
    "name": "ZEEN ZE001W SISAL GRI BEYAZ KOLAY TEMIZLENEBILIR MAKINEDE YIKANABILIR MUTFAK HALISI",
    "description": "Mutfak ve yaşam alanlarında İskandinav ferahlığını arayanlar için tasarlanan Zeen Koleksiyonu ZE001W, gri ve beyazın en dingin tonlarını zeminlerinize getiriyor. Balıksırtı dokumasının zarifliği ile şekillenen bu model, özellikle dar veya az ışık alan mekanları daha geniş ve aydınlık göstermek için ideal bir tercihtir. Modern dekorasyonun vazgeçilmezi olan sisal halı estetiğini, günlük hayatın temizlik kolaylığıyla birleştiren bu tasarım, evinize huzurlu bir atmosfer katar.",
    "tags": [
      "%100 Akrilik",
      "Kolay Temizlenir"
    ],
  ...
  {
    "id": "zeen-ze002b-sisal-bej-kolay-temizlenebilir-makinede-yikanabilir-mutfak-halisi",
    "name": "ZEEN ZE002B SISAL BEJ KOLAY TEMIZLENEBILIR MAKINEDE YIKANABILIR MUTFAK HALISI",
    "description": "Sadelikten yana olanlar için tasarlanan Zeen Koleksiyonu ZE002B, doğanın en sıcak bej tonlarını evinize getiriyor. Çerçevesiz, minimalist tasarımıyla her türlü dekorasyon tarzına kolayca uyum sağlayan bu model; mutfak, koridor ve balkon gibi yaşam alanlarında ferah bir zemin oluşturur. Sisal halı şıklığını, yıkanabilir olmanın pratikliğiyle birleştiren Zeen serisi, modern evlerin yeni favorisi.",
    "tags": [
      "%100 Akrilik",
      "Kolay Temizlenir"
    ],
  ...
  {
    "id": "zeen-ze002g-sisal-gri-beyaz-kolay-temizlenebilir-makinede-yikanabilir-mutfak-halisi",
    "name": "ZEEN ZE002G SISAL GRI BEYAZ KOLAY TEMIZLENEBILIR MAKINEDE YIKANABILIR MUTFAK HALISI",
    "description": "Modern yaşam alanlarında sınırları kaldıran, akıcı bir zemin tasarımı arayanlar için Zeen Koleksiyonu ZE002G mükemmel bir seçenek. Gri ve beyazın kusursuz uyumuyla dokunan bu çerçevesiz model, özellikle dar mutfakları ve koridorları olduğundan daha geniş gösterme etkisine sahiptir. Doğal sisal jüt halı dokusunu, makinede yıkanabilir olmanın rahatlığıyla buluşturan Zeen serisi, evinizde hijyenik bir şıklık yaratır.",
    "tags": [
      "%100 Akrilik",
      "Kolay Temizlenir"
    ],
  ...
  {
    "id": "zeen-ze002w-sisal-bej-beyaz-kolay-temizlenebilir-makinede-yikanabilir-mutfak-halisi",
    "name": "ZEEN ZE002W SISAL BEJ BEYAZ KOLAY TEMIZLENEBILIR MAKINEDE YIKANABILIR MUTFAK HALISI",
    "description": "Doğallığın en zarif halini yansıtan Zeen Koleksiyonu ZE002W, bej renginin sıcaklığını beyazın temizliğiyle harmanlıyor. Mutfak ve yaşam alanlarında aydınlık bir atmosfer yaratmak isteyenler için tasarlanan bu model, sade ve zamansız duruşuyla dekorasyonunuzun tamamlayıcısı olur. Sisal halı dokusunun rustik havasını, makinede yıkanabilir olmanın pratikliğiyle birleştiren Zeen serisi, evinizde konforun yeni adresi olmaya aday.",
    "tags": [
      "%100 Akrilik",
      "Kolay Temizlenir"
    ],
  ...
  {
    "id": "zeen-ze003r-sisal-gri-kolay-temizlenebilir-makinede-yikanabilir-mutfak-halisi",
    "name": "ZEEN ZE003R SISAL GRI KOLAY TEMIZLENEBILIR MAKINEDE YIKANABILIR MUTFAK HALISI",
    "description": "Sıradan düz renklerden sıkılanlar için tasarlanan Zeen Koleksiyonu ZE003R, gri zemin üzerine serpiştirilmiş ince renk geçişleriyle zeminlerinize hareket katıyor. Modern dokuma teknolojisiyle üretilen bu model, sisal halı dayanıklılığını estetik bir formda sunar. Kir göstermeyen yapısı ve makinede yıkanabilir özelliği sayesinde özellikle mutfak, antre ve çocuk odası gibi yoğun trafiğe sahip alanlar için mükemmel bir tercihtir.",
    "tags": [
      "%100 Akrilik",
      "Kolay Temizlenir"
    ],
  ...
  {
    "id": "zeen-ze001g-ozel-olcu-kesme-hali",
    "name": "ZEEN ZE001G OZEL OLCU KESME HALI",
    "description": "Evinizin mimarisine net ve modern bir imza atmak isteyenler için Zeen Koleksiyonu ZE001G Özel Ölçü Serisi karşınızda. Gri zemin üzerine siyah çerçeve detayıyla tasarlanan bu model, özellikle uzun koridorlarda ve L tipi mutfaklarda zemini bir tablo gibi çerçeveler. Standart halıların uymadığı alanlarda, \"Siz hayal edin, biz keselim\" prensibiyle hazırladığımız bu sisal jüt halı serisi, mekana derinlik ve karakter kazandırır.",
    "tags": [
      "%100 Akrilik",
      "Kolay Temizlenir"
    ],
  ...
  {
    "id": "zeen-ze001w-ozel-olcu-kesme-hali",
    "name": "ZEEN ZE001W OZEL OLCU KESME HALI",
    "description": "Evinizin en az ışık alan koridorlarını veya dar mutfaklarını ferahlatmak için tasarlanan Zeen Koleksiyonu ZE001W Özel Ölçü Serisi, gri ve beyazın aydınlık etkisini zeminlerinize taşıyor. Standart ölçülere bağlı kalmadan, mekanınızın ihtiyacı olan uzunlukta sipariş verebileceğiniz bu model, İskandinav dekorasyon stilini evinizin her köşesine yayar. Doğal sisal halı dokusunun zarafetini, kişiselleştirilebilir ebat seçenekleriyle birleştiren bu seri, mekanınıza özel bir mimari dokunuş sunar.",
    "tags": [
      "%100 Akrilik",
      "Kolay Temizlenir"
    ],
  ...
  {
    "id": "zeen-ze002b-ozel-olcu-kesme-hali",
    "name": "ZEEN ZE002B OZEL OLCU KESME HALI",
    "description": "Yaşam alanlarında akıcı ve bütünsel bir görünüm arayanlar için Zeen Koleksiyonu ZE002B Özel Ölçü Serisi en ideal tercihtir. Herhangi bir çerçeve veya sınır çizgisi barındırmayan bu düz bej model, özellikle çok uzun koridorlarda veya odalar arası geçişlerde \"mekanı bölmeyen\" bir devamlılık sağlar. İhtiyacınız olan uzunlukta sipariş edebileceğiniz bu sisal halı, sadeliğin gücünü evinizin her santimine yayar.",
    "tags": [
      "%100 Akrilik",
      "Kolay Temizlenir"
    ],
  ...
  {
    "id": "zeen-ze002g-ozel-olcu-kesme-hali",
    "name": "ZEEN ZE002G OZEL OLCU KESME HALI",
    "description": "Modern mimarinin favori renkleri gri ve beyaz, Zeen Koleksiyonu ZE002G Özel Ölçü Serisi ile zeminlerinizde hayat buluyor. Çerçevesiz (sonsuz desen) yapısı sayesinde, uzun koridorlarda veya odalar arası geçişlerde görsel bir kesinti yaratmadan akıcı bir görünüm sağlar. Standart halıların uymadığı alanlar için \"Kesme Yolluk\" formatında hazırlanan bu model, sisal halı şıklığını evinize tam uyumlu hale getirir.",
    "tags": [
      "%100 Akrilik",
      "Kolay Temizlenir"
    ],
  ...
  {
    "id": "zeen-ze003r-ozel-olcu-kesme-hali",
    "name": "ZEEN ZE003R OZEL OLCU KESME HALI",
    "description": "Standart ve sıradan koridor tasarımlarından uzaklaşmak isteyenler için özel olarak kurgulanan Zeen Koleksiyonu ZE003R Özel Ölçü Serisi, yaşam alanlarınıza modern bir enerji kazandırır. Gri zemin üzerine titizlikle işlenen ince renkli çizgiler, özellikle uzun koridorlarda ve hol geçişlerinde gözü yormayan estetik bir akış sağlar. Evinizin mimari yapısına tam uyum sağlaması adına \"Kesme Yolluk\" formunda hazırlanan bu sisal halı, yüksek dayanıklılığı minimalist bir şıklıkla birleştirir.",
    "tags": [
      "%100 Akrilik",
      "Kolay Temizlenir"
    ],
