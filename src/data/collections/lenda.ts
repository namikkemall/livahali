...
export const lendaCollection: Category = {
  id: "lenda",
  title: "LENDA Serisi",
  ...
  products: [
  {
    "id": "lenda-ld002a-gri-kilim-renkli-detayli-ince-kaymaz-taban-makinada-yikanabilir-salon-hali",
    "name": "LENDA LD002A GRI KILIM RENKLI DETAYLI INCE KAYMAZ TABAN MAKINADA YIKANABILIR SALON HALI",
    "description": "LENDA LD002A GRI KILIM RENKLI DETAYLI INCE KAYMAZ TABAN MAKINADA YIKANABILIR SALON HALI premium carpet model.",
    "tags": [
      "%100 Akrilik",
      "Kolay Temizlenir"
    ],
  ...
  {
    "id": "lenda-ld003a-antrasit-kilim-renkli-detayli-ince-kaymaz-taban-makinada-yikanabilir-salon",
    "name": "LENDA LD003A ANTRASIT KILIM RENKLI DETAYLI INCE KAYMAZ TABAN MAKINADA YIKANABILIR SALON",
    "description": "Karmen Halı Lenda Ld003a, modern yaşam alanlarını renklendiren ince kilim tasarımıyla öne çıkıyor. Antrasit üzerine canlı renk detayları, her yaş grubu için güvenli ve sağlıklı bir ortam yaratıyor. Makinada yıkanabilir özelliği sayesinde, kolay temizlenebilir ve bakım gerektirmeyen bir çözüm sunar. Kaymaz pamuk tabanı, kullanım güvenliği sağlar.",
    "tags": [
      "%100 Akrilik",
      "Kolay Temizlenir"
    ],
  ...
  {
    "id": "lenda-ld004a-gri-kilim-antrasit-detayli-ince-kaymaz-taban-makinada-yikanabilir-hali",
    "name": "LENDA LD004A GRI KILIM ANTRASIT DETAYLI INCE KAYMAZ TABAN MAKINADA YIKANABILIR HALI",
    "description": "Karmen Halı Lenda Ld004a, zarif gri tonlarıyla modern bir görünüm sunarken, antrasit detaylarıyla dikkat çeker. Toz tutmayan özelliği sayesinde sağlığınızı korur ve kaymaz tabanı ile güvenli bir kullanım sağlar. İnce dokusu ve hafifliği, bu halıyı her alan için ideal kılar. Ayrıca çamaşır makinesinde yıkanabilir olması ile temizlik açısından büyük kolaylık sunar.",
    "tags": [
      "%100 Akrilik",
      "Kolay Temizlenir"
    ],
  ...
  {
    "id": "lenda-ld005a-antrasit-kilim-gold-detayli-ince-kaymaz-taban-makinada-yikanabilir-hali",
    "name": "LENDA LD005A ANTRASIT KILIM GOLD DETAYLI INCE KAYMAZ TABAN MAKINADA YIKANABILIR HALI",
    "description": "Karmen Halı Lenda Ld005a, modern antrasit tonları ve şık gold detaylarıyla evinize sofistike bir hava katıyor. Toz tutmayan yapısı sayesinde sağlıklı bir kullanım sunarken, kaymaz pamuk tabanı ile güvenliği ön planda tutar. İnce yapısı, kilim kalınlığında olması ve çamaşır makinesinde yıkanabilir özelliği ile temizlik ve bakımda kolaylık sağlar.",
    "tags": [
      "%100 Akrilik",
      "Kolay Temizlenir"
    ],
  ...
  {
    "id": "lenda-ld006a-antrasit-kilim-gri-detayli-ince-kaymaz-taban-makinada-yikanabilir-hali",
    "name": "LENDA LD006A ANTRASIT KILIM GRI DETAYLI INCE KAYMAZ TABAN MAKINADA YIKANABILIR HALI",
    "description": "Karmen Halı Lenda Ld006a, modern antrasit rengi ve gri detaylarıyla evinizin dekorasyonunu tamamlayacak harika bir seçenek. Toz tutmayan özellikleri sayesinde sağlıklı bir yaşam alanı sunarken, kaymaz tabanı ile her türlü zeminde güvenli bir kullanım sağlar. İnce yapısı ve kilim kalınlığında olmasıyla hafif, pratik ve kullanımı kolaydır. Çamaşır makinesinde yıkanabilir olması, temizliğini çok daha kolay hale getirir.",
    "tags": [
      "%100 Akrilik",
      "Kolay Temizlenir"
    ],
