...
export const lookclassicCollection: Category = {
  id: "look-classic",
  ...
  products: [
    {
      ...
      "name": "LOOK CLASSIC LK001W",
      "description": "LOOK CLASSIC LK001W premium carpet model.",
      "tags": [
        "%100 Akrilik",
        "Kolay Temizlenir"
      ],
    ...
    {
      "id": "look-classic-lk002g",
      "name": "LOOK CLASSIC LK002G",
      "description": "Look Classic LK002G, krem ve gri tonlarını modern geometrik desen ile birleştirerek salon dekorasyonunuza dinamik ve şık bir görünüm kazandırır. Akrilik yapısı sayesinde yumuşak bir kullanım sunarken, pamuk tabanı zeminle uyumlu ve dayanıklı bir destek sağlar. Tozu az özelliği ile günlük temizlik rutininizi kolaylaştırmaya yardımcı olur.",
      "tags": [
        "%100 Akrilik",
        "Kolay Temizlenir"
      ],
    ...
    {
      "id": "look-classic-lk003g",
      "name": "LOOK CLASSIC LK003G",
      "description": "Look Classic LK003G, krem ve gri tonlarını şık çerçeveli modern desenlerle birleştirerek yaşam alanlarınıza zarif ve dengeli bir görünüm kazandırır. %100 akrilik dokusu sayesinde yumuşak bir kullanım sunarken, pamuk tabanı zeminde daha stabil ve dayanıklı bir destek sağlar. Tozu az yüzeyi ile günlük temizlik rutininizi kolaylaştırmaya yardımcı olur; salon ve oturma odası gibi yoğun kullanılan alanlar için ideal bir tercihtir.",
      "tags": [
        "%100 Akrilik",
        "Kolay Temizlenir"
      ],
    ...
    {
      "id": "look-classic-lk004g",
      "name": "LOOK CLASSIC LK004G",
      "description": "Look Classic LK004G, krem rengin sıcaklığını klasik çerçeveli desenle birleştirerek oturma odası ve salon dekorasyonunuza zamansız bir şıklık kazandırır. Akrilik yüzeyi yumuşak bir kullanım hissi sunarken, pamuk tabanı zeminle uyumlu ve dayanıklı bir yapı sağlar. Tozu az özelliği sayesinde günlük temizlik daha pratik hale gelir.",
      "tags": [
        "%100 Akrilik",
        "Kolay Temizlenir"
      ],
    ...
    {
      "id": "look-classic-lk005b",
      "name": "LOOK CLASSIC LK005B",
      "description": "Look Classic LK005B, krem ve bej tonlarının zarif uyumunu klasik çerçeveli desenle buluşturarak yaşam alanlarınıza sıcak ve şık bir atmosfer kazandırır. Akrilik yüzeyi yumuşak bir kullanım sunarken, pamuk dokuma tabanı dayanıklı ve zemin dostu bir yapı sağlar. Günlük kullanıma uygun yapısı sayesinde hem dekoratif hem fonksiyonel bir tercih sunar.",
      "tags": [
        "%100 Akrilik",
        "Kolay Temizlenir"
      ],
    ...
    {
      "id": "look-classic-lk005m",
      "name": "LOOK CLASSIC LK005M",
      "description": "Look Classic LK005M, krem ve gri tonlarının dengeli uyumunu klasik çerçeve deseniyle bir araya getirerek yaşam alanlarınıza zarif ve sofistike bir görünüm kazandırır. Yumuşak akrilik yüzeyi konforlu bir kullanım sunarken, pamuk dokuma tabanı dayanıklılığı artırır ve zemine uyum sağlar. Hem klasik hem modern dekorasyon stilleriyle rahatlıkla kombinlenebilir.",
      "tags": [
        "%100 Akrilik",
        "Kolay Temizlenir"
      ],
    ...
    {
      "id": "look-classic-lk006b",
      "name": "LOOK CLASSIC LK006B",
      "description": "Look Classic LK006B, bej rengin sıcak ve doğal duruşunu klasik çerçeveli desen ile birleştirerek oturma odası ve salonlara zamansız bir şıklık kazandırır. Akrilik dokusu sayesinde yumuşak bir kullanım hissi sunar. Pamuk dokuma tabanı ise zemine uyumlu, dayanıklı ve uzun ömürlü kullanım için tasarlanmıştır. Tozu az yapısı sayesinde günlük temizlik rutininizi pratikleştirmeye yardımcı olur.",
      "tags": [
        "%100 Akrilik",
        "Kolay Temizlenir"
      ],
